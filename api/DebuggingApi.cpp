...
DebuggingApi::DebuggingApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<void> DebuggingApi::disableDebuggerUsingDELETE(utility::string_t customerId)
{
    

    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = U("/v2/_debug/{customerId}");
    boost::replace_all(path, U("{") U("customerId") U("}"), ApiClient::parameterToString(customerId));
    ...
    {
        throw ApiException(400, U("DebuggingApi->disableDebuggerUsingDELETE does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("DebuggingApi->disableDebuggerUsingDELETE does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        if (response.status_code() >= 400)
        {
            throw ApiException(response.status_code()
                , U("error calling disableDebuggerUsingDELETE: ") + response.reason_phrase()
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            if( contentType.find(responseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , U("error calling disableDebuggerUsingDELETE: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
...
pplx::task<void> DebuggingApi::enableDebuggerUsingPOST(utility::string_t customerId)
{
    ...
    {
        throw ApiException(400, U("DebuggingApi->enableDebuggerUsingPOST does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("DebuggingApi->enableDebuggerUsingPOST does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , U("error calling enableDebuggerUsingPOST: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , U("error calling enableDebuggerUsingPOST: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
