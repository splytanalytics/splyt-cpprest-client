...
pplx::task<void> DebuggingApi::disableDebugger(utility::string_t customerId)
{
    ...
    {
        throw ApiException(400, U("DebuggingApi->disableDebugger does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("DebuggingApi->disableDebugger does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        if (response.status_code() >= 400)
        {
            throw ApiException(response.status_code()
                , U("error calling disableDebugger: ") + response.reason_phrase()
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            if( contentType.find(responseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , U("error calling disableDebugger: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
...
pplx::task<void> DebuggingApi::enableDebugger(utility::string_t customerId)
{
    ...
    {
        throw ApiException(400, U("DebuggingApi->enableDebugger does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("DebuggingApi->enableDebugger does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , U("error calling enableDebugger: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , U("error calling enableDebugger: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
