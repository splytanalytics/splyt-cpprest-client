...
pplx::task<void> DevicesApi::newDeviceUsingPOST(utility::string_t customerId, std::shared_ptr<DataCollectorNewDeviceRequest> request, bool checked)
{
    

    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = U("/v2/devices");
    ...
    {
        throw ApiException(400, U("DevicesApi->newDeviceUsingPOST does not produce any supported media type"));
    }
    ...
    {
        queryParams[U("checked")] = ApiClient::parameterToString(checked);
    }
    ...
    {
        throw ApiException(415, U("DevicesApi->newDeviceUsingPOST does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        if (response.status_code() >= 400)
        {
            throw ApiException(response.status_code()
                , U("error calling newDeviceUsingPOST: ") + response.reason_phrase()
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            if( contentType.find(responseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , U("error calling newDeviceUsingPOST: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
...
pplx::task<void> DevicesApi::updateDeviceStateUsingPUT(utility::string_t id, utility::string_t customerId, std::shared_ptr<DataCollectorUpdateDeviceStateRequest> request)
{
    

    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = U("/v2/devices/{id}");
    ...
    {
        throw ApiException(400, U("DevicesApi->updateDeviceStateUsingPUT does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("DevicesApi->updateDeviceStateUsingPUT does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , U("error calling updateDeviceStateUsingPUT: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , U("error calling updateDeviceStateUsingPUT: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
