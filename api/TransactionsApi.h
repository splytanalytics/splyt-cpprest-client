...
public:
    ...
    pplx::task<void> beginTransaction(utility::string_t customerId, std::shared_ptr<DataCollectorBeginTransactionRequest> request);
    /// <summary>
    ...
    pplx::task<void> endTransaction(utility::string_t id, utility::string_t customerId, std::shared_ptr<DataCollectorEndTransactionRequest> request);
    /// <summary>
    ...
    pplx::task<void> updateCollection(utility::string_t customerId, std::shared_ptr<DataCollectorUpdateCollectionRequest> request);
    /// <summary>
    ...
    pplx::task<void> updateTransaction(utility::string_t id, utility::string_t customerId, std::shared_ptr<DataCollectorUpdateTransactionRequest> request);
