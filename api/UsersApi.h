...
public:
    ...
    pplx::task<void> newUser(utility::string_t customerId, std::shared_ptr<DataCollectorNewUserRequest> request, bool checked);
    /// <summary>
    ...
    pplx::task<void> updateUserState(utility::string_t id, utility::string_t customerId, std::shared_ptr<DataCollectorUpdateUserStateRequest> request);
