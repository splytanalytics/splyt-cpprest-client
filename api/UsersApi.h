...
public:
    ...
    /// </remarks>
    /// <param name="customerId">customerId</param>/// <param name="request">New user information (optional)</param>/// <param name="checked">Flag indicating whether the user state should be checked before updating the state in the Knetik.io platform (optional, default to false)</param>
    pplx::task<void> newUserUsingPOST(utility::string_t customerId, std::shared_ptr<DataCollectorNewUserRequest> request, bool checked);
    /// <summary>
    ...
    /// 
    /// </remarks>
    /// <param name="id">ID of the user for whom state is being updated</param>/// <param name="customerId">customerId</param>/// <param name="request">Updated user state information (optional)</param>
    pplx::task<void> updateUserStateUsingPUT(utility::string_t id, utility::string_t customerId, std::shared_ptr<DataCollectorUpdateUserStateRequest> request);
