...
/*
 * MobileApplicationTrackingApi.h
 *
 * 
 */

#ifndef MobileApplicationTrackingApi_H_
#define MobileApplicationTrackingApi_H_
...
class  MobileApplicationTrackingApi
{
public:
    MobileApplicationTrackingApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~MobileApplicationTrackingApi();
    /// <summary>
    ...
    /// 
    /// </remarks>
    /// <param name="customerId">customerId</param>/// <param name="request">Tune campaign tracking information (optional)</param>
    pplx::task<void> handleTuneRequestUsingPOST(utility::string_t customerId, std::shared_ptr<DataCollectorTuneRequest> request);
...
#endif /* MobileApplicationTrackingApi_H_ */
