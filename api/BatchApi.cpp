...
pplx::task<void> BatchApi::submitBatch(std::shared_ptr<DataCollectorBatchRequest> batchRequest, utility::string_t customerId)
{
    
    // verify the required parameter 'batchRequest' is set
    if (batchRequest == nullptr)
    {
        throw ApiException(400, U("Missing required parameter 'batchRequest' when calling BatchApi->submitBatch"));
    }
