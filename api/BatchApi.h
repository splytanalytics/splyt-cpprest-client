...
public:
    ...
    /// </remarks>
    /// <param name="customerId">customerId</param>/// <param name="batchRequest">The batch of requests to submit (optional)</param>
    pplx::task<std::vector<std::shared_ptr<BatchRequestResult>>> submitBatch(utility::string_t customerId, std::shared_ptr<DataCollectorBatchRequest> batchRequest);
