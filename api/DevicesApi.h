...
public:
    ...
    pplx::task<void> newDevice(utility::string_t customerId, std::shared_ptr<DataCollectorNewDeviceRequest> request, bool checked);
    /// <summary>
    ...
    pplx::task<void> updateDeviceState(utility::string_t id, utility::string_t customerId, std::shared_ptr<DataCollectorUpdateDeviceStateRequest> request);
