...
#include "DataCollectorUpdateDeviceStateRequest.h"
...
public:
    ...
    /// </remarks>
    /// <param name="customerId">customerId</param>/// <param name="request">New device information (optional)</param>/// <param name="checked">Flag indicating whether the device state should be checked before updating the state in the Knetik.io platform (optional, default to false)</param>
    pplx::task<void> newDeviceUsingPOST(utility::string_t customerId, std::shared_ptr<DataCollectorNewDeviceRequest> request, bool checked);
    /// <summary>
    ...
    /// 
    /// </remarks>
    /// <param name="id">ID of the device for which state information is being updated</param>/// <param name="customerId">customerId</param>/// <param name="request">Updated device state information (optional)</param>
    pplx::task<void> updateDeviceStateUsingPUT(utility::string_t id, utility::string_t customerId, std::shared_ptr<DataCollectorUpdateDeviceStateRequest> request);
