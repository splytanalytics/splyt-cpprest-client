...
{
public:
    DebuggingApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~DebuggingApi();
    /// <summary>
    ...
    pplx::task<void> disableDebuggerUsingDELETE(utility::string_t customerId);
    /// <summary>
    ...
    /// </remarks>
    /// <param name="customerId">customerId</param>
    pplx::task<void> enableDebuggerUsingPOST(utility::string_t customerId);
