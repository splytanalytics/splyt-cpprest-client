...
{
public:
    EventsApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~EventsApi();
    /// <summary>
    ...
    /// 
    /// </remarks>
    /// <param name="customerId">customerId</param>/// <param name="request">Similar to transactions, the details of that event (optional)</param>
    pplx::task<void> createEventUsingPOST(utility::string_t customerId, std::shared_ptr<NewEventRequest> request);
