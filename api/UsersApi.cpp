...
pplx::task<void> UsersApi::newUserUsingPOST(utility::string_t customerId, std::shared_ptr<DataCollectorNewUserRequest> request, bool checked)
{
    

    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = U("/v2/users");
    ...
    {
        throw ApiException(400, U("UsersApi->newUserUsingPOST does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("UsersApi->newUserUsingPOST does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        if (response.status_code() >= 400)
        {
            throw ApiException(response.status_code()
                , U("error calling newUserUsingPOST: ") + response.reason_phrase()
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            if( contentType.find(responseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , U("error calling newUserUsingPOST: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
...
pplx::task<void> UsersApi::updateUserStateUsingPUT(utility::string_t id, utility::string_t customerId, std::shared_ptr<DataCollectorUpdateUserStateRequest> request)
{
    

    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = U("/v2/users/{id}");
    ...
    {
        throw ApiException(400, U("UsersApi->updateUserStateUsingPUT does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("UsersApi->updateUserStateUsingPUT does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , U("error calling updateUserStateUsingPUT: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , U("error calling updateUserStateUsingPUT: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
