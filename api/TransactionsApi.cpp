...
pplx::task<void> TransactionsApi::beginTransactionUsingPOST(utility::string_t customerId, std::shared_ptr<DataCollectorBeginTransactionRequest> request)
{
    ...
    {
        throw ApiException(400, U("TransactionsApi->beginTransactionUsingPOST does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("TransactionsApi->beginTransactionUsingPOST does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        if (response.status_code() >= 400)
        {
            throw ApiException(response.status_code()
                , U("error calling beginTransactionUsingPOST: ") + response.reason_phrase()
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            if( contentType.find(responseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , U("error calling beginTransactionUsingPOST: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
...
pplx::task<void> TransactionsApi::endTransactionUsingPUT(utility::string_t id, utility::string_t customerId, std::shared_ptr<DataCollectorEndTransactionRequest> request)
{
    ...
    {
        throw ApiException(400, U("TransactionsApi->endTransactionUsingPUT does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("TransactionsApi->endTransactionUsingPUT does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , U("error calling endTransactionUsingPUT: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , U("error calling endTransactionUsingPUT: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
...
pplx::task<void> TransactionsApi::updateCollectionUsingPOST(utility::string_t customerId, std::shared_ptr<DataCollectorUpdateCollectionRequest> request)
{
    ...
    {
        throw ApiException(400, U("TransactionsApi->updateCollectionUsingPOST does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("TransactionsApi->updateCollectionUsingPOST does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , U("error calling updateCollectionUsingPOST: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , U("error calling updateCollectionUsingPOST: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
...
pplx::task<void> TransactionsApi::updateTransactionUsingPUT(utility::string_t id, utility::string_t customerId, std::shared_ptr<DataCollectorUpdateTransactionRequest> request)
{
    ...
    {
        throw ApiException(400, U("TransactionsApi->updateTransactionUsingPUT does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("TransactionsApi->updateTransactionUsingPUT does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , U("error calling updateTransactionUsingPUT: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , U("error calling updateTransactionUsingPUT: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
