...
/*
 * DataCollectorUpdateTransactionRequest.h
 *
 * 
 */

#ifndef DataCollectorUpdateTransactionRequest_H_
#define DataCollectorUpdateTransactionRequest_H_
...
/// 
/// </summary>
class  DataCollectorUpdateTransactionRequest
    : public ModelBase
{
public:
    DataCollectorUpdateTransactionRequest();
    virtual ~DataCollectorUpdateTransactionRequest();
    ...
    /////////////////////////////////////////////
    /// DataCollectorUpdateTransactionRequest members
...
std::shared_ptr<Object> m_EventProperties;
    bool m_EventPropertiesIsSet;
int64_t m_EventTimestamp;
    int32_t m_Progress;
    utility::string_t m_RequestType;
    int64_t m_SendTimestamp;
...
#endif /* DataCollectorUpdateTransactionRequest_H_ */
