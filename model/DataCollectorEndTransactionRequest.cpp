...
void DataCollectorEndTransactionRequest::unsetDeviceId()
{
    m_DeviceIdIsSet = false;
}
...
void DataCollectorEndTransactionRequest::unsetEventProperties()
{
    m_EventPropertiesIsSet = false;
}
...
void DataCollectorEndTransactionRequest::unsetTransactionId()
{
    m_TransactionIdIsSet = false;
}
...
void DataCollectorEndTransactionRequest::unsetUserId()
{
    m_UserIdIsSet = false;
}
