...
/*
 * DataCollectorBatchRequest.h
 *
 * 
 */

#ifndef DataCollectorBatchRequest_H_
#define DataCollectorBatchRequest_H_
...
/// 
/// </summary>
class  DataCollectorBatchRequest
    : public ModelBase
{
public:
    DataCollectorBatchRequest();
    virtual ~DataCollectorBatchRequest();
    ...
    /////////////////////////////////////////////
    /// DataCollectorBatchRequest members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<DataCollectorBaseRequest>>& getBatch();
    bool batchIsSet() const;
    void unsetBatch();
    void setBatch(std::vector<std::shared_ptr<DataCollectorBaseRequest>> value);

protected:
    std::vector<std::shared_ptr<DataCollectorBaseRequest>> m_Batch;
    bool m_BatchIsSet;
};
...
#endif /* DataCollectorBatchRequest_H_ */
