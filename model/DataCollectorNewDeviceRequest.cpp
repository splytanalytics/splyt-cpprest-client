...
#include "DataCollectorNewDeviceRequest.h"
...
void DataCollectorNewDeviceRequest::validate()
{
    // TODO: implement validation
}

web::json::value DataCollectorNewDeviceRequest::toJson() const
{
...
void DataCollectorNewDeviceRequest::fromJson(web::json::value& val)
{
...
void DataCollectorNewDeviceRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void DataCollectorNewDeviceRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
utility::string_t DataCollectorNewDeviceRequest::getDeviceId() const
{
    return m_Device_id;
}
void DataCollectorNewDeviceRequest::setDeviceId(utility::string_t value)
{
    m_Device_id = value;
    
}
std::shared_ptr<Object> DataCollectorNewDeviceRequest::getEventProperties() const
{
    return m_Event_properties;
}
void DataCollectorNewDeviceRequest::setEventProperties(std::shared_ptr<Object> value)
{
    m_Event_properties = value;
    m_Event_propertiesIsSet = true;
}
bool DataCollectorNewDeviceRequest::event_propertiesIsSet() const
{
    return m_Event_propertiesIsSet;
}
void DataCollectorNewDeviceRequest::unsetEvent_properties()
{
    m_Event_propertiesIsSet = false;
}
int64_t DataCollectorNewDeviceRequest::getEventTimestamp() const
{
    return m_Event_timestamp;
}
void DataCollectorNewDeviceRequest::setEventTimestamp(int64_t value)
{
    m_Event_timestamp = value;
    
}
utility::string_t DataCollectorNewDeviceRequest::getRequestType() const
{
    return m_Request_type;
}
void DataCollectorNewDeviceRequest::setRequestType(utility::string_t value)
{
    m_Request_type = value;
    
}
int64_t DataCollectorNewDeviceRequest::getSendTimestamp() const
{
    return m_Send_timestamp;
}
void DataCollectorNewDeviceRequest::setSendTimestamp(int64_t value)
{
    m_Send_timestamp = value;
    
}
utility::string_t DataCollectorNewDeviceRequest::getUserId() const
{
    return m_User_id;
}
void DataCollectorNewDeviceRequest::setUserId(utility::string_t value)
{
    m_User_id = value;
    m_User_idIsSet = true;
}
bool DataCollectorNewDeviceRequest::user_idIsSet() const
{
    return m_User_idIsSet;
}
void DataCollectorNewDeviceRequest::unsetUser_id()
{
    m_User_idIsSet = false;
}
