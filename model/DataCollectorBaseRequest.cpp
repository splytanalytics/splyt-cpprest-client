...
void DataCollectorBaseRequest::validate()
{
    // TODO: implement validation
}

web::json::value DataCollectorBaseRequest::toJson() const
{
...
void DataCollectorBaseRequest::fromJson(web::json::value& val)
{
...
void DataCollectorBaseRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void DataCollectorBaseRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
utility::string_t DataCollectorBaseRequest::getDeviceId() const
{
    return m_Device_id;
}
void DataCollectorBaseRequest::setDeviceId(utility::string_t value)
{
    m_Device_id = value;
    m_Device_idIsSet = true;
}
bool DataCollectorBaseRequest::device_idIsSet() const
{
    return m_Device_idIsSet;
}
void DataCollectorBaseRequest::unsetDevice_id()
{
    m_Device_idIsSet = false;
}
std::shared_ptr<Object> DataCollectorBaseRequest::getEventProperties() const
{
    return m_Event_properties;
}
void DataCollectorBaseRequest::setEventProperties(std::shared_ptr<Object> value)
{
    m_Event_properties = value;
    m_Event_propertiesIsSet = true;
}
bool DataCollectorBaseRequest::event_propertiesIsSet() const
{
    return m_Event_propertiesIsSet;
}
void DataCollectorBaseRequest::unsetEvent_properties()
{
    m_Event_propertiesIsSet = false;
}
int64_t DataCollectorBaseRequest::getEventTimestamp() const
{
    return m_Event_timestamp;
}
void DataCollectorBaseRequest::setEventTimestamp(int64_t value)
{
    m_Event_timestamp = value;
    
}
utility::string_t DataCollectorBaseRequest::getRequestType() const
{
    return m_Request_type;
}
void DataCollectorBaseRequest::setRequestType(utility::string_t value)
{
    m_Request_type = value;
    
}
int64_t DataCollectorBaseRequest::getSendTimestamp() const
{
    return m_Send_timestamp;
}
void DataCollectorBaseRequest::setSendTimestamp(int64_t value)
{
    m_Send_timestamp = value;
    
}
utility::string_t DataCollectorBaseRequest::getUserId() const
{
    return m_User_id;
}
void DataCollectorBaseRequest::setUserId(utility::string_t value)
{
    m_User_id = value;
    m_User_idIsSet = true;
}
bool DataCollectorBaseRequest::user_idIsSet() const
{
    return m_User_idIsSet;
}
void DataCollectorBaseRequest::unsetUser_id()
{
    m_User_idIsSet = false;
}
