...
bool DataCollectorBaseRequest::deviceIdIsSet() const
{
...
bool DataCollectorBaseRequest::eventPropertiesIsSet() const
{
...
bool DataCollectorBaseRequest::userIdIsSet() const
{
