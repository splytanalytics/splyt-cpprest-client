...
void DataCollectorUpdateTransactionRequest::validate()
{
...
void DataCollectorUpdateTransactionRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void DataCollectorUpdateTransactionRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
void DataCollectorUpdateTransactionRequest::setCategory(utility::string_t value)
{
    m_Category = value;
...
void DataCollectorUpdateTransactionRequest::unsetDeviceId()
{
    m_DeviceIdIsSet = false;
}
...
void DataCollectorUpdateTransactionRequest::unsetEventProperties()
{
    m_EventPropertiesIsSet = false;
}
...
void DataCollectorUpdateTransactionRequest::setTransactionId(utility::string_t value)
{
    m_TransactionId = value;
    m_TransactionIdIsSet = true;
}
bool DataCollectorUpdateTransactionRequest::transactionIdIsSet() const
{
    return m_TransactionIdIsSet;
}
void DataCollectorUpdateTransactionRequest::unsetTransactionId()
{
    m_TransactionIdIsSet = false;
}
...
void DataCollectorUpdateTransactionRequest::unsetUserId()
{
    m_UserIdIsSet = false;
}
