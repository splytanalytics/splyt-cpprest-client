...
web::json::value DataCollectorBeginTransactionRequest::toJson() const
{
    ...
    if(m_TimeoutModeIsSet)
    {
        val[U("timeoutMode")] = ModelBase::toJson(m_TimeoutMode);
    }
...
void DataCollectorBeginTransactionRequest::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(U("timeoutMode")))
    {
        setTimeoutMode(ModelBase::stringFromJson(val[U("timeoutMode")]));
...
void DataCollectorBeginTransactionRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_TimeoutModeIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + U("timeoutMode"), m_TimeoutMode));
...
void DataCollectorBeginTransactionRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(U("timeoutMode")))
    {
        setTimeoutMode(ModelBase::stringFromHttpContent(multipart->getContent(U("timeoutMode"))));
...
utility::string_t DataCollectorBeginTransactionRequest::getDeviceId() const
{
    return m_DeviceId;
}
void DataCollectorBeginTransactionRequest::setDeviceId(utility::string_t value)
{
    m_DeviceId = value;
    m_DeviceIdIsSet = true;
}
bool DataCollectorBeginTransactionRequest::deviceIdIsSet() const
{
    return m_DeviceIdIsSet;
}
void DataCollectorBeginTransactionRequest::unsetDeviceId()
{
    m_DeviceIdIsSet = false;
}
std::shared_ptr<Object> DataCollectorBeginTransactionRequest::getEventProperties() const
{
    return m_EventProperties;
}
void DataCollectorBeginTransactionRequest::setEventProperties(std::shared_ptr<Object> value)
{
    m_EventProperties = value;
    m_EventPropertiesIsSet = true;
}
bool DataCollectorBeginTransactionRequest::eventPropertiesIsSet() const
{
    return m_EventPropertiesIsSet;
}
void DataCollectorBeginTransactionRequest::unsetEventProperties()
{
    m_EventPropertiesIsSet = false;
}
int64_t DataCollectorBeginTransactionRequest::getEventTimestamp() const
{
    return m_EventTimestamp;
}
void DataCollectorBeginTransactionRequest::setEventTimestamp(int64_t value)
{
    m_EventTimestamp = value;
    
}
utility::string_t DataCollectorBeginTransactionRequest::getRequestType() const
{
    return m_RequestType;
}
void DataCollectorBeginTransactionRequest::setRequestType(utility::string_t value)
{
    m_RequestType = value;
    
}
int64_t DataCollectorBeginTransactionRequest::getSendTimestamp() const
{
    return m_SendTimestamp;
}
void DataCollectorBeginTransactionRequest::setSendTimestamp(int64_t value)
{
...
void DataCollectorBeginTransactionRequest::unsetTransactionId()
{
    m_TransactionIdIsSet = false;
}
utility::string_t DataCollectorBeginTransactionRequest::getUserId() const
{
    return m_UserId;
}
void DataCollectorBeginTransactionRequest::setUserId(utility::string_t value)
{
    m_UserId = value;
    m_UserIdIsSet = true;
}
bool DataCollectorBeginTransactionRequest::userIdIsSet() const
{
    return m_UserIdIsSet;
}
void DataCollectorBeginTransactionRequest::unsetUserId()
{
    m_UserIdIsSet = false;
}
