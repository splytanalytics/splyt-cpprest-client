...
void DataCollectorUpdateDeviceStateRequest::validate()
{
...
void DataCollectorUpdateDeviceStateRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
bool DataCollectorUpdateDeviceStateRequest::event_propertiesIsSet() const
{
...
bool DataCollectorUpdateDeviceStateRequest::user_idIsSet() const
{
